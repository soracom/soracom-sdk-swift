...
public final class CreateAndUpdateCredentialsModel: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CreateAndUpdateCredentialsModel else { return false }
    ...
    public static func == (lhs: CreateAndUpdateCredentialsModel, rhs: CreateAndUpdateCredentialsModel) -> Bool {
