...
public final class CreateCouponResponse: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CreateCouponResponse else { return false }
    ...
    public static func == (lhs: CreateCouponResponse, rhs: CreateCouponResponse) -> Bool {
