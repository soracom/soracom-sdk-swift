...
public final class EstimatedOrderModel: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EstimatedOrderModel else { return false }
    ...
    public static func == (lhs: EstimatedOrderModel, rhs: EstimatedOrderModel) -> Bool {
