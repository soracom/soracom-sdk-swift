...
public final class EventHandlerModel: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EventHandlerModel else { return false }
    ...
    public static func == (lhs: EventHandlerModel, rhs: EventHandlerModel) -> Bool {
