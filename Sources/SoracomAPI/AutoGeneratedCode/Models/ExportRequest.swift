...
public final class ExportRequest: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ExportRequest else { return false }
    ...
    public static func == (lhs: ExportRequest, rhs: ExportRequest) -> Bool {
