...
public final class FunnelDestination: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? FunnelDestination else { return false }
    ...
    public static func == (lhs: FunnelDestination, rhs: FunnelDestination) -> Bool {
