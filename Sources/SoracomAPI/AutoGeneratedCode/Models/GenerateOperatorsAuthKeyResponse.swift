...
public final class GenerateOperatorsAuthKeyResponse: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? GenerateOperatorsAuthKeyResponse else { return false }
      guard self.authKey == object.authKey else { return false }
      guard self.authKeyId == object.authKeyId else { return false }
      return true
    }

    public static func == (lhs: GenerateOperatorsAuthKeyResponse, rhs: GenerateOperatorsAuthKeyResponse) -> Bool {
