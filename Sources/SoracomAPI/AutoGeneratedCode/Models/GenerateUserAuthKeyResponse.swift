...
public final class GenerateUserAuthKeyResponse: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? GenerateUserAuthKeyResponse else { return false }
      guard self.authKey == object.authKey else { return false }
      guard self.authKeyId == object.authKeyId else { return false }
      return true
    }

    public static func == (lhs: GenerateUserAuthKeyResponse, rhs: GenerateUserAuthKeyResponse) -> Bool {
