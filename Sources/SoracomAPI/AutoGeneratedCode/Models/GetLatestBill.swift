...
public final class GetLatestBill: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? GetLatestBill else { return false }
      guard self.amount == object.amount else { return false }
      guard self.lastEvaluatedTime == object.lastEvaluatedTime else { return false }
      return true
    }

    public static func == (lhs: GetLatestBill, rhs: GetLatestBill) -> Bool {
