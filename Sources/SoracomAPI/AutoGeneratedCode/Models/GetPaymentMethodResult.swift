...
public final class GetPaymentMethodResult: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? GetPaymentMethodResult else { return false }
    ...
    public static func == (lhs: GetPaymentMethodResult, rhs: GetPaymentMethodResult) -> Bool {
