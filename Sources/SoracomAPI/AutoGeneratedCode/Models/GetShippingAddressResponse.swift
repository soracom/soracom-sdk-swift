...
public final class GetShippingAddressResponse: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? GetShippingAddressResponse else { return false }
    ...
    public static func == (lhs: GetShippingAddressResponse, rhs: GetShippingAddressResponse) -> Bool {
