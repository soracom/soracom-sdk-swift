...
public final class InsertAirStatsRequest: Codable, Equatable {

    public var dataTrafficStatsMap: [String: Any]?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? InsertAirStatsRequest else { return false }
    ...
    public static func == (lhs: InsertAirStatsRequest, rhs: InsertAirStatsRequest) -> Bool {
