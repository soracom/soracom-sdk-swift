...
public final class IssueSubscriberTransferTokenRequest: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? IssueSubscriberTransferTokenRequest else { return false }
    ...
    public static func == (lhs: IssueSubscriberTransferTokenRequest, rhs: IssueSubscriberTransferTokenRequest) -> Bool {
