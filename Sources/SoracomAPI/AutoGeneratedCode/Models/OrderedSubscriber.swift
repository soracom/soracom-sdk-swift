...
public final class OrderedSubscriber: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? OrderedSubscriber else { return false }
    ...
    public static func == (lhs: OrderedSubscriber, rhs: OrderedSubscriber) -> Bool {
