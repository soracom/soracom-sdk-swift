...
public final class RegisterSubscribersRequest: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? RegisterSubscribersRequest else { return false }
    ...
    public static func == (lhs: RegisterSubscribersRequest, rhs: RegisterSubscribersRequest) -> Bool {
