...
public final class SigfoxDevice: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SigfoxDevice else { return false }
    ...
    public static func == (lhs: SigfoxDevice, rhs: SigfoxDevice) -> Bool {
