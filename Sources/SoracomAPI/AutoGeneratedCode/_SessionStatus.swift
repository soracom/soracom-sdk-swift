...
open class _SessionStatus: Codable, Equatable {

    open var dnsServers: [String]?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _SessionStatus else { return false }
    ...
    public static func == (lhs: _SessionStatus, rhs: _SessionStatus) -> Bool {
