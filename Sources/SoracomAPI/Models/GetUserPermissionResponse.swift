// GetUserPermissionResponse.swift Created by Mason Mark on 2018-07-25. Copyright © 2018 Soracom, Inc. All rights reserved.

import Foundation

public class GetUserPermissionResponse: _GetUserPermissionResponse {

    // The base implementation for this class is provided by the
    // auto-generated superclass (_GetUserPermissionResponse).
    //
