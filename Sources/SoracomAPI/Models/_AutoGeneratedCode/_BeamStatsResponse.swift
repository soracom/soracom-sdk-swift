...
open class _BeamStatsResponse: Codable, Equatable {

    open var beamStatsMap: [String: SoracomBeamStats]?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _BeamStatsResponse else { return false }
    ...
    public static func == (lhs: _BeamStatsResponse, rhs: _BeamStatsResponse) -> Bool {
