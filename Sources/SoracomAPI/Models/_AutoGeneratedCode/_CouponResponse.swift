...
open class _CouponResponse: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _CouponResponse else { return false }
    ...
    public static func == (lhs: _CouponResponse, rhs: _CouponResponse) -> Bool {
