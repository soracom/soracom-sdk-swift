...
open class _CreateCouponResponse: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _CreateCouponResponse else { return false }
    ...
    public static func == (lhs: _CreateCouponResponse, rhs: _CreateCouponResponse) -> Bool {
