...
open class _CreateRoleResponse: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _CreateRoleResponse else { return false }
      guard self.roleId == object.roleId else { return false }
      return true
    }

    public static func == (lhs: _CreateRoleResponse, rhs: _CreateRoleResponse) -> Bool {
