...
open class _CredentialsModel: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _CredentialsModel else { return false }
    ...
    public static func == (lhs: _CredentialsModel, rhs: _CredentialsModel) -> Bool {
