...
open class _Device: Codable, Equatable {
    ...
    open var lastRegistrationUpdate: DateTime?

    open var manufacturer: String?

    open var modelNumber: String?

    open var objects: [String: Any]?
    ...
    open var registrationLifeTime: Int?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _Device else { return false }
    ...
    public static func == (lhs: _Device, rhs: _Device) -> Bool {
