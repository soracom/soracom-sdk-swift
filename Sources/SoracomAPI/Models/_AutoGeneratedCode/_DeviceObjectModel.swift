...
open class _DeviceObjectModel: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _DeviceObjectModel else { return false }
    ...
    public static func == (lhs: _DeviceObjectModel, rhs: _DeviceObjectModel) -> Bool {
