...
open class _EstimatedOrderItemModel: Codable, Equatable {

    /** 商品 */
    open var product: ProductModel?

    /** 商品金額 */
    open var productAmount: Double?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _EstimatedOrderItemModel else { return false }
    ...
    public static func == (lhs: _EstimatedOrderItemModel, rhs: _EstimatedOrderItemModel) -> Bool {
