...
open class _GenerateUserAuthKeyResponse: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _GenerateUserAuthKeyResponse else { return false }
      guard self.authKey == object.authKey else { return false }
      guard self.authKeyId == object.authKeyId else { return false }
      return true
    }

    public static func == (lhs: _GenerateUserAuthKeyResponse, rhs: _GenerateUserAuthKeyResponse) -> Bool {
