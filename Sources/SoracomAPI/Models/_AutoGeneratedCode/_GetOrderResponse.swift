...
open class _GetOrderResponse: Codable, Equatable {
    ...
    /** 宅配便送り状番号 */
    open var shippingLabelNumber: String?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _GetOrderResponse else { return false }
    ...
    public static func == (lhs: _GetOrderResponse, rhs: _GetOrderResponse) -> Bool {
