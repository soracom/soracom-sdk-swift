...
open class _GetPaymentTransactionResult: Codable, Equatable {
    ...
    /** 課金額 */
    open var amount: PaymentAmount?

    /** 課金内容詳細 */
    open var description: PaymentDescription?

    /** メッセージ */
    open var message: String?

    /** メッセージコード */
    open var messageCode: MessageCode?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _GetPaymentTransactionResult else { return false }
    ...
    public static func == (lhs: _GetPaymentTransactionResult, rhs: _GetPaymentTransactionResult) -> Bool {
