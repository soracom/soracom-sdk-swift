...
open class _GetShippingAddressResponse: Codable, Equatable {
    ...
    public init(city: String, shippingAddressId: String, shippingArea: String, state: String, zipCode: String, addressLine1: String? = nil, addressLine2: String? = nil, building: String? = nil, companyName: String? = nil, department: String? = nil, fullName: String? = nil, phoneNumber: String? = nil) {
        self.city = city
    ...
    public required init(from decoder: Decoder) throws {
        ...
        shippingAddressId = try container.decode(.shippingAddressId)
        shippingArea = try container.decode(.shippingArea)
    ...
    open func encode(to encoder: Encoder) throws {
        ...
        try container.encode(shippingAddressId, forKey: .shippingAddressId)
        try container.encode(shippingArea, forKey: .shippingArea)
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _GetShippingAddressResponse else { return false }
    ...
    public static func == (lhs: _GetShippingAddressResponse, rhs: _GetShippingAddressResponse) -> Bool {
