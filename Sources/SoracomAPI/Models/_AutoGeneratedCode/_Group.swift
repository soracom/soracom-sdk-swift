...
open class _Group: Codable, Equatable {

    open var configuration: Map?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _Group else { return false }
    ...
    public static func == (lhs: _Group, rhs: _Group) -> Bool {
