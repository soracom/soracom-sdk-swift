...
open class _LoraDevice: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _LoraDevice else { return false }
    ...
    public static func == (lhs: _LoraDevice, rhs: _LoraDevice) -> Bool {
