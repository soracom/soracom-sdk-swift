...
open class _LoraGateway: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _LoraGateway else { return false }
    ...
    public static func == (lhs: _LoraGateway, rhs: _LoraGateway) -> Bool {
