...
open class _RegisterPayerInformationModel: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _RegisterPayerInformationModel else { return false }
    ...
    public static func == (lhs: _RegisterPayerInformationModel, rhs: _RegisterPayerInformationModel) -> Bool {
