...
open class _ResourceInstance: Codable, Equatable {
    ...
    open var mandatory: Bool?

    open var multiple: Bool?

    open var name: String?

    open var observed: Bool?

    open var operations: Operations?

    open var rangeEnumeration: String?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _ResourceInstance else { return false }
    ...
    public static func == (lhs: _ResourceInstance, rhs: _ResourceInstance) -> Bool {
