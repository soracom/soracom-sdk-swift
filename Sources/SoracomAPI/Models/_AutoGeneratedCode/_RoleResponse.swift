...
open class _RoleResponse: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _RoleResponse else { return false }
    ...
    public static func == (lhs: _RoleResponse, rhs: _RoleResponse) -> Bool {
