...
open class _RuleConfig: Codable, Equatable {
    ...
    open var properties: RuleConfigProperty
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _RuleConfig else { return false }
      guard self.properties == object.properties else { return false }
      guard self.type == object.type else { return false }
      return true
    }

    public static func == (lhs: _RuleConfig, rhs: _RuleConfig) -> Bool {
