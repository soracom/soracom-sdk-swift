...
open class _RuleConfigProperty: Codable, Equatable {
    ...
    open var limitTotalTrafficMegaByte: Int

    open var inactiveTimeoutDateConst: InactiveTimeoutDateConst?

    /** SubscriberSpeedClassAttributeRule の時のみ有効 */
    open var targetSpeedClass: TargetSpeedClass?

    /** SubscriberStatusAttributeRule の時のみ有効 */
    open var targetStatus: TargetStatus?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _RuleConfigProperty else { return false }
    ...
    public static func == (lhs: _RuleConfigProperty, rhs: _RuleConfigProperty) -> Bool {
