...
open class _SetUserPermissionRequest: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _SetUserPermissionRequest else { return false }
      guard self.permission == object.permission else { return false }
      guard self.description == object.description else { return false }
      return true
    }

    public static func == (lhs: _SetUserPermissionRequest, rhs: _SetUserPermissionRequest) -> Bool {
