...
/** 発送料 */
open class _ShippingCostModel: Codable, Equatable {
    ...
    /** 発送先エリア */
    open var shippingArea: ShippingArea?

    /** 発送先エリア名称 */
    open var shippingAreaName: String?
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _ShippingCostModel else { return false }
    ...
    public static func == (lhs: _ShippingCostModel, rhs: _ShippingCostModel) -> Bool {
