...
open class _UpdateSpeedClassRequest: Codable, Equatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? _UpdateSpeedClassRequest else { return false }
      guard self.speedClass == object.speedClass else { return false }
      return true
    }

    public static func == (lhs: _UpdateSpeedClassRequest, rhs: _UpdateSpeedClassRequest) -> Bool {
