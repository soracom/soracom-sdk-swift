...
extension Request {
    ...
    public class func _updateLagoonUserPassword(
        ...
        let path = "/lagoon/users/{lagoon_user_id}/password".replacingOccurrences(of: "{" + "lagoonUserId" + "}", with: "\(lagoonUserId)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
