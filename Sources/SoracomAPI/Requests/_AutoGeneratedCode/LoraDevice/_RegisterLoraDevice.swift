...
extension Request {
    ...
    public class func _registerLoraDevice(
        ...
        let path = "/lora_devices/{device_id}/register".replacingOccurrences(of: "{" + "deviceId" + "}", with: "\(deviceId)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
