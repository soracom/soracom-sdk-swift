...
extension Request {
    ...
    public class func _setLoraNetworkSet(
        ...
        let path = "/lora_gateways/{gateway_id}/set_network_set".replacingOccurrences(of: "{" + "gatewayId" + "}", with: "\(gatewayId)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
