...
extension Request {
    ...
    public class func _unsetSigfoxDeviceGroup(
        ...
        let path = "/sigfox_devices/{device_id}/unset_group".replacingOccurrences(of: "{" + "deviceId" + "}", with: "\(deviceId)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
