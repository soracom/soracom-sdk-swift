...
extension Request {
    ...
    public class func _exportAirStats(
        ...
        let path = "/stats/air/operators/{operator_id}/export".replacingOccurrences(of: "{" + "operatorId" + "}", with: "\(operatorId)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
