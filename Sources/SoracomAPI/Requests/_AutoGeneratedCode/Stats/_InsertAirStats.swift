...
extension Request {
    ...
    public class func _insertAirStats(
        ...
        let path = "/sandbox/stats/air/subscribers/{imsi}".replacingOccurrences(of: "{" + "imsi" + "}", with: "\(imsi)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
