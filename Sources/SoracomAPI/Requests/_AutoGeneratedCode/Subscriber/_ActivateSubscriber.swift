...
extension Request {
    ...
    public class func _activateSubscriber(
        ...
        let path = "/subscribers/{imsi}/activate".replacingOccurrences(of: "{" + "imsi" + "}", with: "\(imsi)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
