...
extension Request {
    ...
    public class func _deactivateSubscriber(
        ...
        let path = "/subscribers/{imsi}/deactivate".replacingOccurrences(of: "{" + "imsi" + "}", with: "\(imsi)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
