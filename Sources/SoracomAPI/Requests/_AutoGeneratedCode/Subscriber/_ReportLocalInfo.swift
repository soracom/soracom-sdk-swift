...
extension Request {
    ...
    public class func _reportLocalInfo(
        ...
        let path = "/subscribers/{imsi}/report_local_info".replacingOccurrences(of: "{" + "imsi" + "}", with: "\(imsi)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
