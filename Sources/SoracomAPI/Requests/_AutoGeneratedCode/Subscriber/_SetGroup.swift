...
extension Request {
    ...
    public class func _setGroup(
        ...
        let path = "/subscribers/{imsi}/set_group".replacingOccurrences(of: "{" + "imsi" + "}", with: "\(imsi)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
