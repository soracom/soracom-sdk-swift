...
extension Request {
    ...
    public class func _setImeiLock(
        ...
        let path = "/subscribers/{imsi}/set_imei_lock".replacingOccurrences(of: "{" + "imsi" + "}", with: "\(imsi)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
