...
extension Request {
    ...
    public class func _suspendSubscriber(
        ...
        let path = "/subscribers/{imsi}/suspend".replacingOccurrences(of: "{" + "imsi" + "}", with: "\(imsi)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
