...
extension Request {
    ...
    public class func _terminateSubscriber(
        ...
        let path = "/subscribers/{imsi}/terminate".replacingOccurrences(of: "{" + "imsi" + "}", with: "\(imsi)") // This nonsense should be fixed in the code generator, we might do a PR for at some point...
