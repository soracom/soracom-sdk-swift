// IssueSubscriberTransferTokenRequest.swift Generated by swagger-codegen  — Custom output templates and post-processing by CodeGeneratorForSoracomSDKSwift.Swaggerer version 0.0d1. Generated 2016-09-12T00:54:57Z
...
public class IssueSubscriberTransferTokenRequest: PayloadConvertible {
    ...
    public static func from(_ payload: Payload?) -> Self? {
        ...
        result.transferDestinationOperatorEmail = payload.decodeString(.transferDestinationOperatorEmail)
        result.transferDestinationOperatorId = payload.decodeString(.transferDestinationOperatorId)
