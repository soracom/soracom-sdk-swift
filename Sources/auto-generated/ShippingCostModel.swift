// ShippingCostModel.swift Generated by swagger-codegen  — Custom output templates and post-processing by CodeGeneratorForSoracomSDKSwift.Swaggerer version 0.0d1. Generated 2016-09-12T00:54:57Z
...
public class ShippingCostModel: PayloadConvertible {
    ...
    public static func from(_ payload: Payload?) -> Self? {
        ...
        result.shippingArea = payload.decodeShippingArea(.shippingArea)
        result.shippingAreaName = payload.decodeString(.shippingAreaName)
        result.shippingCost = payload.decodeDouble(.shippingCost)
        result.size = payload.decodeInt64(.size)
        return result
    }
