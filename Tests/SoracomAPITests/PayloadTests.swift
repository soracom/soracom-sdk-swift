...
//        ]
    ...
    func test_linux_JSONSerialization_vs_Int64() {
            ...
            do {
                ...
                print(jsonData)
                print(jsonData.utf8String ?? "WTF")
                XCTFail("Hmm, JSONSerialization decoded big int: \(jsonData.utf8String ?? "INVALID")")
                  // if we get here, no error occurred.. I'm testing the assumption that JSONSerialization can't serialize Int64
                  // Mason 2018-02-07: update: This now passes, as of current Swift 4.1 beta on Ubuntu 16.04... but, I am not sure
                  // what to do with this — IIRC there is no (and likely never will be) support for 32-bit Linux, so maybe we're
                  // good? But since I haven't checked yet, I am leaving this failing for the moment. It's probably good news that
                  // this assumption is no longer true, though...
            } catch {
                print(error)
            }
        #endif
