...
open class CreateEventHandlerRequest: Codable {
    ...
    public init(actionConfigList: [ActionConfig], description: String?, name: String?, ruleConfig: RuleConfig, status: Status, targetGroupId: String?, targetImsi: String?, targetOperatorId: String?, targetTag: Tag?) {
